...
for(i in c("fqlibrary3y")) {
  levels(mcsmini[, i]) <- c("On special occasions", "Once a month", "Once a fortnight", "Once a week")
}

for(i in c("fqread5y", "fqstories5y", "fqsongs5y", "fqpaint5y", "fqphysical5y", "fqindoor5y", "fqpark5y")) {
  levels(mcsmini[, i]) <- c("Not at all", "Less often", "Once or twice a month", "Once or twice a week", "Several times a week", "Every day")
}
